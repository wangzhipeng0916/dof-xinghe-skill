...
function checkExecutableSkill_priest_metamorphosis(character)
{
    ...
    if(isAvengerAwakenning(character) 
        ...
        || CNSquirrelAppendage.sq_IsAppendAppendage(character, "character/xinghe/priest/metamorphosis/ap_metamorphosis.nut")) 
        return false;
