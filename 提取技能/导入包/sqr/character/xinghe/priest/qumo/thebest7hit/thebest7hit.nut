        ...
        case 0:
            if (attacker.getVar().getBool(0) == false)
            {
                ...
                if (sq_IsGrabable(attacker, target)
                    ...
                    && !sq_IsFixture(target))
                {
                    if (CNSquirrelAppendage.sq_IsAppendAppendage(target, "character/xinghe/priest/qumo/thebest7hit/ap_thebest7hit.nut"))
                        CNSquirrelAppendage.sq_RemoveAppendage(target, "character/xinghe/priest/qumo/thebest7hit/ap_thebest7hit.nut");
                    local appendage = CNSquirrelAppendage.sq_AppendAppendage(target, attacker, 239, true, "character/xinghe/priest/qumo/thebest7hit/ap_thebest7hit.nut", true);
