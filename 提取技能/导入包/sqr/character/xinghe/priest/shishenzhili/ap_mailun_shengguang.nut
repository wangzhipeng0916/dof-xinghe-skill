...
function proc_appendage_mailun_shengguang(appendage)
{
	...
	local isAppendApd = CNSquirrelAppendage.sq_IsAppendAppendage(parentObj, "character/xinghe/priest/shishenzhili/ap_mailun_lieyan.nut");
	if(isAppendApd)
	{
...
function onStart_appendage_mailun_shengguang(appendage)
{
	...
	appendage.sq_AddEffectFront("character/xinghe/priest/shishenzhili/light/loopyellow_yellow_f.ani");
	local parentObj = appendage.getParent();
}
