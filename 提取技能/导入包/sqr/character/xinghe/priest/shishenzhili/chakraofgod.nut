...
function onProcCon_chakraofgod(obj)
{
    ...
    {
        // 火焰屬性效果處理
        if (CNSquirrelAppendage.sq_IsAppendAppendage(obj, "character/xinghe/priest/shishenzhili/ap_mailun_lieyan.nut") == true)
        {
        ...
        // 聖光屬性效果處理
        if (CNSquirrelAppendage.sq_IsAppendAppendage(obj, "character/xinghe/priest/shishenzhili/ap_mailun_shengguang.nut") == true)
        {
            local passiveObj1 = obj.getMyPassiveObject(24001, obj.getMyPassiveObjectCount(24001) - 1);
            if (passiveObj1 && passiveObj1.getVar("flag").size_vector() == 0)
            {
