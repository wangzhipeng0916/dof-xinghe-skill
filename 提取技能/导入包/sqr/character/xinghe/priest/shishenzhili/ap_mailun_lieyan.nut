...
function proc_appendage_mailun_lieyan(appendage)
{
	...
	local isAppendApd = CNSquirrelAppendage.sq_IsAppendAppendage(parentObj, "character/xinghe/priest/shishenzhili/ap_mailun_shengguang.nut");
	if(isAppendApd)
	{
...
function onStart_appendage_mailun_lieyan(appendage)
{
	...
	appendage.sq_AddEffectFront("character/xinghe/priest/shishenzhili/fire/loopred_red_f.ani"); // 添加前效果
	local parentObj = appendage.getParent();
}
