...
function onSetState_priest_jupiter(character, state, data, skillInfo)
{
    ...
    switch(subState)
    {
        case 0:
            ...
            if(CNSquirrelAppendage.sq_IsAppendAppendage(character, "character/xinghe/priest/shengqi/jupiter/ap_jupiter.nut") == true)
            {
...
function onEndCurrentAni_priest_jupiter(character)
{
    ...
    switch(subState)
    {
        case 0:
            ...
            break;
        case 1:
            if(!CNSquirrelAppendage.sq_IsAppendAppendage(character, "character/xinghe/priest/shengqi/jupiter/ap_jupiter.nut")) 
            {
                sq_BinaryStartWrite();
...
{
    if(!character) return;
    local appendage = CNSquirrelAppendage.sq_AppendAppendage(character, character, 250, false, "character/xinghe/priest/shengqi/jupiter/ap_jupiter.nut", false); 
