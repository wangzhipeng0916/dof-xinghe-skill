...
function onAppendAppendageAddEff_priest_divinepunishment(character, data)
{
    ...
    for (local i = 0; i < targetCount; i++)
    {
        ...
        if (targetCharacter && !targetCharacter.isDead())
        {
            local appendage = CNSquirrelAppendage.sq_AppendAppendage(targetCharacter, targetCharacter, 251, false, "character/xinghe/priest/shengqi/divinepunishment/ap_divinepunishment.nut", false);
