...
function onEnterFrame_AtomicSmash(obj, state)
{
    ...
    if (state == 15)
    {
        local buffCalmnessPath = "character/xinghe/priest/appendage/ap_buff_chakraofcalmness.nut";
        local buffPassionPath = "character/xinghe/priest/appendage/ap_buff_chakraofpassion.nut";
