        ...
        case 2:
            ...
            for (local i = 0; i < objectCount; i++)
            {
                ...
                if (sq_IsGrabable(character, targetObj)
                    ...
                    && !CNSquirrelAppendage.sq_IsAppendAppendage(targetObj, "character/xinghe/priest/wrathofgod/ap_wrathofgod.nut"))
                {
                    ...
                    if (!activeObject.isDead())
                    {
                        ...
                        {
                            local appendage = CNSquirrelAppendage.sq_AppendAppendage(activeObject, character, 245, true, "character/xinghe/priest/wrathofgod/ap_wrathofgod.nut", true);
