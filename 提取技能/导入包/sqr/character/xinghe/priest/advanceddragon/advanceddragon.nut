...
function checkExecutableSkill_priest_advanceddragon(playerObject)
{
    ...
    if (!CNSquirrelAppendage.sq_IsAppendAppendage(playerObject, "character/xinghe/priest/appendage/ap_buff_chakraofcalmness.nut")
        && !CNSquirrelAppendage.sq_IsAppendAppendage(playerObject, "character/xinghe/priest/appendage/ap_buff_chakraofpassion.nut"))
        return false;
