...
function onAttack_priest_doomcrush(characterObject, targetObject, attackInfoIndex, isNotActive)
{
    ...
    switch (subState)
    {
        ...
        case 1:
            ...
            {
                if (CNSquirrelAppendage.sq_IsAppendAppendage(targetObject, "character/xinghe/priest/fuchou/doomcrush/ap_doomcrush.nut"))
                    CNSquirrelAppendage.sq_RemoveAppendage(targetObject, "character/xinghe/priest/fuchou/doomcrush/ap_doomcrush.nut");
                local appendage = CNSquirrelAppendage.sq_AppendAppendage(targetObject, characterObject, 137, false, "character/xinghe/priest/fuchou/doomcrush/ap_doomcrush.nut", true);
    ...
    switch (subState)
    {
        ...
        case 1:
            ...
            if (characterObject.getVar().getBool(0) == true)
            {
                ...
                {
                    if (!CNSquirrelAppendage.sq_IsAppendAppendage(characterObject, "character/xinghe/priest/fuchou/metamorphosis/ap_metamorphosis.nut"))
